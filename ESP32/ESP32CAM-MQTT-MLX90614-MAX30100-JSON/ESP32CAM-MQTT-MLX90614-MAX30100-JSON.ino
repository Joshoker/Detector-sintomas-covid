/*
 * Programa del detector de sintomas COVID 
 * Por: Joshua Nava
 ...
 * para medir los principales indicadores del COVID, los cuales 
 * son ritmo cardiaco, temperatura y oxigenacion en la sangre. Se enviara 
...
#include <Wire.h> // Biblioteca para comuncación I2C
